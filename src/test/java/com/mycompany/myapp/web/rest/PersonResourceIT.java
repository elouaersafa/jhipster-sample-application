...
class PersonResourceIT {
    ...
    private static final String DEFAULT_PERSON_LAST_NAME = "AAAAAAAAAA";
    private static final String UPDATED_PERSON_LAST_NAME = "BBBBBBBBBB";
    ...
    public static Person createEntity(EntityManager em) {
        Person person = new Person().personName(DEFAULT_PERSON_NAME).personLastName(DEFAULT_PERSON_LAST_NAME);
        return person;
    }
    ...
    public static Person createUpdatedEntity(EntityManager em) {
        Person person = new Person().personName(UPDATED_PERSON_NAME).personLastName(UPDATED_PERSON_LAST_NAME);
        return person;
    }
    ...
    void createPerson() throws Exception {
        ...
        assertThat(testPerson.getPersonLastName()).isEqualTo(DEFAULT_PERSON_LAST_NAME);
    }
    ...
    void getAllPeople() throws Exception {
        ...
        restPersonMockMvc
            ...
            .andExpect(jsonPath("$.[*].personLastName").value(hasItem(DEFAULT_PERSON_LAST_NAME)));
    }
    ...
    void getPerson() throws Exception {
        ...
        restPersonMockMvc
            ...
            .andExpect(jsonPath("$.personLastName").value(DEFAULT_PERSON_LAST_NAME));
    }
    ...
    void putNewPerson() throws Exception {
        ...
        updatedPerson.personName(UPDATED_PERSON_NAME).personLastName(UPDATED_PERSON_LAST_NAME);
        ...
        assertThat(testPerson.getPersonLastName()).isEqualTo(UPDATED_PERSON_LAST_NAME);
    }
    ...
    void fullUpdatePersonWithPatch() throws Exception {
        ...
        partialUpdatedPerson.personName(UPDATED_PERSON_NAME).personLastName(UPDATED_PERSON_LAST_NAME);
